...
export const candidatesTable = pgTable("candidates", {
  ...
  careerPreference: text("career_preference").array().default([]),
  preferredWorkMode: text("preferred_work_mode").array().default([]),
  interestedSkills: text("interested_skills").array().default([]),
