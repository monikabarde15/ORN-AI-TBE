...
import CourseStudentGrid from "./learning-path/CourseStudentGrid";
import TabNavigation from "./learning-path-manage/TabNavigation";
import CoursesStudentTab from "./learning-path-manage/CoursesStudentTab";
import SessionsTab from "./learning-path-manage/SessionsTab";
import SessionForm from "./learning-path-manage/SessionForm";
import LearningPathStudentSidebar from "./learning-path-manage/LearningPathStudentSidebar";
...
export default function LearningPathManage() {
    ...
    const [match, params] = useRoute("/recruiter/learning-path-manage-view/:id");
