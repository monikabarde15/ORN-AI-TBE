import{m as u,r as o,j as r,a as e,L as n,F as c}from"./index-570fc221.js";import{N as h,F as g}from"./Footer-516f849d.js";import{H as m}from"./Banner-14f0e081.js";import{o as a}from"./proxy-17319d3c.js";import"./createLucideIcon-6a7b8dfb.js";function x(){const{id:i}=u(),[t,s]=o.useState(null),l=[{id:1,title:"The Future of Learning: How ORN-AI Is Empowering Global Talent",excerpt:`
    ...
    `,thumbnail:"../../assets/blogs/1.svg"},{id:2,title:"Why Ethical Placement Matters — And How ORN-AI Is Changing the Game",excerpt:`
    ...
    `,thumbnail:"../../assets/blogs/2.svg"},{id:3,title:"The Power of Cross-Technology Training in 2025: Why You Need It",excerpt:`
    ...
    `,thumbnail:"../../assets/blogs/3.svg"},{id:4,title:"From Classroom to Career: How ORN-AI Supports You Beyond Training",excerpt:`
    ...
    `,thumbnail:"../../assets/blogs/4.svg"}];return o.useEffect(()=>{const p=l.find(d=>d.id===Number(i));s(p||null)},[i]),t?r(c,{children:[e(h,{}),e(m,{title:t.title,subtitle:"Your subtitle or description goes here",ctaText:"Sign up",ctaHref:"/signup",image:"https://cdn.prod.website-files.com/66446d71a3755a2d4e53fe14/668baff40b223db5311c7fda_network-connections.png",height:"h-96"}),e("div",{className:"min-h-screen bg-[#fff] text-white py-20 px-5 md:px-20",children:r(a.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},className:"max-w-5xl mx-auto",children:[r("div",{className:"relative overflow-hidden rounded-2xl mb-8 group shadow-lg shadow-[#fff]",children:[e(a.img,{whileHover:{scale:1.05},transition:{duration:.6},src:t.thumbnail,alt:t.title,className:"rounded-2xl w-full object-cover max-h-[500px] transition-transform duration-700 group-hover:brightness-110"}),e("div",{className:"absolute inset-0 bg-gradient-to-t from-[#0b0718]/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"})]}),e(a.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.3},className:"prose prose-lg max-w-none text-black",dangerouslySetInnerHTML:{__html:t.excerpt}}),e(a.div,{className:"mt-10",initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.4},children:e(n,{to:"/blogs",className:"inline-block px-6 py-3 rounded-full bg-[linear-gradient(90deg,#170d3e_30%,#080e1f_100%)]  font-medium text-white",children:"← Back to Blogs"})})]})}),e(g,{})]}):r("div",{className:"min-h-screen flex flex-col items-center justify-center text-white bg-[#0b0718]",children:[e("p",{className:"text-lg mb-3",children:"⚠️ Blog not found."}),e(n,{to:"/blogs",className:"px-5 py-2 rounded-lg bg-gradient-to-r from-[#7c4dff] to-[#3f95ff] hover:from-[#9063ff] hover:to-[#66b9ff] transition-all duration-300 transform hover:scale-105 shadow-lg",children:"← Back to Blogs"})]})}export{x as default};
